...
const Contact = () => {
  return (
    <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 dark:bg-gray-900 dark:text-gray-100">
	...
	<form  className="space-y-6 ng-untouched ng-pristine ng-valid">
		...
		<div>
			...
			<textarea id="message"  className="w-full p-3 rounded bg-gray-800"></textarea>
		</div>
